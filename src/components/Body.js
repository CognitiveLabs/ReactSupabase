...
const Body = () => {
  return (
    <main className="justify-center items-center">
      <h1 className=" signika-header font-extrabold sm:text-4xl">My Calendy</h1>

      <h2 className=" signika-title font-extrabold pb-10 sm:text-4xl">
        the Cognitive Calendar
      </h2>

      <p className="signika text-center mobile-body">
      ...
      <p className="signika  text-center pt-10">
